...
export default function OwnedMethodCard() {
                ...
                <div className="max-w-7xl mx-auto py-3 px-3 sm:px-3 lg:px-3">
                  <div className="flex items-center justify-between flex-wrap">
                    ...
                    <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                      <button type="button" className="-mr-1 flex p-2 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center">
                    ...
                    <div className="flex lg:justify-start">
                      <div className="rounded-md shadow">
                        <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-sm rounded-md text-white bg-green-600 hover:bg-green-700 md:py-4 md:px-10">
                          Search
                        </a>
                      </div>
                    </div>
