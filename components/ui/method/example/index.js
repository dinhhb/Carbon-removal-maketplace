      ...
      <div>
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2">
            <div className="px-4 py-6 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-0">
              <dt className="text-2xl font-medium leading-6 text-gray-900">Tổng quan</dt>
                {overview.split('\n').map((paragraph, index) => (
                  <p key={index} className={index === 0 ? "mt-3 text-base text-gray-500 sm:mt-5 sm:mx-auto md:mt-5 md:text-xl lg:mx-0" : "mt-1 text-base leading-6 text-gray-700 sm:col-san-2 sm:mt-0"}>
                    {paragraph}
                  </p>
                ))}
            </div>
              ...
              <dd className="mt-2 text-base text-gray-900 sm:col-span-2 sm:mt-0">
                <ul role="list" className="border border-gray-200 divide-y divide-gray-100 rounded-md">
                  { researchPapers.map(researchPaper => 
                    <li key={researchPaper} className="flex items-center justify-between py-4 pl-4 pr-5 text-base leading-6">
          ...
          <div className="col-span-1">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-base font-medium leading-6 text-gray-900">Độ bền</dt>
              <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                {durability}
              </dd>
            </div>
            <hr className="my-1 border-t-1 border-gray-200" /> {/* Horizontal line */}
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-base font-medium leading-6 text-gray-900">Quy mô</dt>
              <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                {scale}
              </dd>
            </div>
            <hr className="my-1 border-t-1 border-gray-200" /> {/* Horizontal line */}
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-base font-medium leading-6 text-gray-900">Đã được mua bởi</dt>
              <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-san-2 sm:mt-0">
                {alsoBoughtBy}
              </dd>
            </div>
            <hr className="my-1 border-t-1 border-gray-200" /> {/* Horizontal line */}
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-base font-medium leading-6 text-gray-900">Địa điểm dự án</dt>
              <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-san-2 sm:mt-0">
                {projectLocation}
              </dd>
            </div>
